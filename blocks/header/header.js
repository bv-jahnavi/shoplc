...
export default async function decorate(block) {
  ...
  const wishlist = document.createRange().createContextualFragment(`
    <div class="wishlist-wrapper nav-tools-wrapper">
      <a href="/customer/wishlist" class="nav-wishlist-button" aria-label="Wishlist">
      <svg width="20" height="20" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" 
      viewBox="0 0 20 17" style="line-height:1;vertical-align: middle;" xml:space="preserve">
<path id="Path_60" fill="#000" d="M18.4,1.7c-1.1-1.1-2.5-1.7-4-1.7c-1.5,0-2.9,0.6-4,1.6L10,2L9.6,1.6C8.5,0.6,7.1,0,5.6,0 
...
c1.1,0,2.2,0.5,3,1.3C19,4.3,19,7,17.3,8.6z"/>
  ...
  const minicart = document.createRange().createContextualFragment(`
     <div class="minicart-wrapper nav-tools-wrapper">
       <button type="button" class="nav-cart-button" aria-label="Cart">Cart</button>
